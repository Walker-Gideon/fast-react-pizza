      ...
      <Form method="POST">
        ...
        <div>
          ...
          <div>
            <input
              type="text"
              className="w-full rounded-full border border-stone-200 px-4 py-2 transition-all duration-300 placeholder:text-stone-400 focus:ring focus:ring-yellow-400 focus:outline-none md:px-6 md:py-3"
              name="address"
              required
            />
          </div>
